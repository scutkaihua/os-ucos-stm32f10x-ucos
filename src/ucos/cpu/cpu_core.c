...
typedef struct
{
  CPU_INT32U SYSCLK_Frequency;  /*!< returns SYSCLK clock frequency expressed in Hz */
  CPU_INT32U HCLK_Frequency;    /*!< returns HCLK clock frequency expressed in Hz */
  CPU_INT32U PCLK1_Frequency;   /*!< returns PCLK1 clock frequency expressed in Hz */
  CPU_INT32U PCLK2_Frequency;   /*!< returns PCLK2 clock frequency expressed in Hz */
  CPU_INT32U ADCCLK_Frequency;  /*!< returns ADCCLK clock frequency expressed in Hz */
}RCC_ClocksTypeDef;
